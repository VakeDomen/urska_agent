...
staff:     bash wait-port.sh 127.0.0.1 8002 && bash wait-port.sh 127.0.0.1 7999 && cd mcp-staff         && cargo run --release
programme: bash wait-port.sh 127.0.0.1 8002 && bash wait-port.sh 127.0.0.1 7999 && cd mcp-programme     && cargo run --release
